...
namespace Facebook.Samples.Views
{
    ...
    public sealed partial class HomePage : Page
    {
        ...
        string _facebookAppId = "" // Moneyslate's app ID, didn't want to put it publicly on Github
        string _permissions = "user_about_me,read_stream"; // Set your permissions here
